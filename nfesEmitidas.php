...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Organizador XML - organização manual de notas fiscais emitidas para esta empresa</title>
	...
	<body>
		...
		<div class="container-narrow">
			...
			<legend>Organização manual de notas fiscais emitidas para esta empresa</legend>
			<textarea rows="10" class="span6"><?php
				print date('d-m-Y_H:i:s ') . "início\n";
				ob_flush();
				flush();
				require_once("organizaNfesEmitidas.php");
